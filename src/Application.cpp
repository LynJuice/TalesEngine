...
void Application::pickPhysicalDevice()
{
    ...
    for (const auto &device : devices)
    {
        ...
        {
            std::cout << "\033[1;31m" << "Device " << device << " is not suitable!" << "\033[0m" << std::endl;
        }
    }
...
void Application::createTextureImage()
{
    ...
    stbi_uc* pixels = stbi_load("textures/cheese.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
